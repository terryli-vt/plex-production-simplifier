...
const About: React.FC = () => {
  return (
    <div className="p-6 bg-base-200 min-h-[70vh]">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-lg mt-2">
          My name is Tianyu (Terry) Li, and I am the software developer behind
          this web application. My goal is to create tools that simplify complex
        ...
        <p className="text-lg mt-2">
          ...
          accuracy into inventory data and enhance operational efficiency.
        </p>
